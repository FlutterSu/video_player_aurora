...
/// An Aurora implementation of [VideoPlayerPlatform] that uses the
/// Pigeon-generated [VideoPlayerApi].
class AuroraVideoPlayer extends VideoPlayerPlatform {
  final AuroraVideoPlayerApi _api = AuroraVideoPlayerApi();

  /// Registers this class as the default instance of [PathProviderPlatform].
  static void registerWith() {
    VideoPlayerPlatform.instance = AuroraVideoPlayer();
  }
